class NavbarNotSignedInClass2 extends HTMLElement {  
  ...
  connectedCallback() {
    this.innerHTML = `
    <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - Top Shadow START -->
    <div class="navbar-2-outline-shadow box-shadow-reg-grey-2">
      <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - Top Shadow END -->
        ...
        <div class="navbar-links-2-not-signed-in">
          <ul>
            <li class="navbar-list-item-1"><a href="#">How It Works <i class="fas fa-angle-down navbar-drop-down-arrow-1"></i></a>
              ...
              <ul class="links-level-2 box-shadow-reg-grey-2">
            ...
            <div class="navbar-not-signed-in-demo-button-section">
              <a href="#"><button class="button-default-2 button-default-2-primary-color navbar-not-signed-in-button-position">Request a demo</button></a>
            </div>
          </ul>
        </div>
