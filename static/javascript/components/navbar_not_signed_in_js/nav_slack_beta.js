    ...
    this.innerHTML = `
      <nav class="navbar">
        <ul>
          ...
          <!-- <a href="https://slack.com/oauth/v2/authorize?client_id=2010284559270.2041074682000&scope=app_mentions:read,channels:history,channels:read,chat:write,groups:read,im:read,incoming-webhook,mpim:read,reactions:read,team:read,usergroups:read,users.profile:read,users:read,users:read.email,chat:write.public&state=${this.getAttribute("slack_state_uuid_js")}"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcSet="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a> -->

          <a href="https://slack.com/oauth/v2/authorize?client_id=2010284559270.2041074682000&scope=app_mentions:read,channels:history,channels:read,chat:write,groups:read,im:read,incoming-webhook,mpim:read,reactions:read,team:read,usergroups:read,users.profile:read,users:read,users:read.email,chat:write.public"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcSet="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>
        </ul>
      </nav>
    `;
  }
