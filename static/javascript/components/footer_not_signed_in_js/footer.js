      ...
      <div class="footer-not-signed-in-background">
        <div class="footer-not-signed-in-links">
          ...
          <div class="footer-not-signed-in-links-group-2">
            ...
            <ul>
              <li><a href="${this.getAttribute("link_blog_js")}">Blog</a></li>
          ...
          <div class="footer-not-signed-in-links-group-3">
            ...
            <div class="footer-not-signed-in-copyright">
              ...
              <p class="privacy-and-tos-footer"><a href="${this.getAttribute("link_terms_conditions_js")}">Terms & Conditions</a> | <a href="${this.getAttribute("link_privacy_js")}">Privacy</a></p>
            </div>
          </div>
        </div>
      </div>
