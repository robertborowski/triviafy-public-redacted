...
for(var i = 0; i < img_array.length; i++) {
  if(img_array[i].src == 'http://localhost:5000/create/question/user/form/submit/no%20aws%20image%20url' || img_array[i].src == 'https://5cafebb4ee66.ngrok.io/create/question/user/form/submit/no%20aws%20image%20url' || img_array[i].src == 'https://triviafy.com/create/question/user/form/submit/no%20aws%20image%20url') {
