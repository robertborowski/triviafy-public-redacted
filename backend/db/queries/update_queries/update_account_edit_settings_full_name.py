...
def update_account_edit_settings_full_name_function(postgres_connection, postgres_cursor, user_input_quiz_settings_edit_full_name, user_uuid):
  ...
  try:
    # ------------------------ Query START ------------------------
    postgres_cursor.execute("UPDATE triviafy_user_login_information_table_slack SET user_display_name=%s WHERE user_uuid=%s", [user_input_quiz_settings_edit_full_name, user_uuid])
    # ------------------------ Query END ------------------------
