...
def select_triviafy_slack_messages_sent_table_search_user_uuid_category_function(postgres_connection, postgres_cursor, user_uuid, slack_message_sent_search_category, uuid_quiz):
  localhost_print_function('=========================================== select_triviafy_slack_messages_sent_table_search_user_uuid_category_function START ===========================================')
  ...
  try:
    ...
    if result_row == None or result_row == []:
      localhost_print_function('=========================================== select_triviafy_slack_messages_sent_table_search_user_uuid_category_function END ===========================================')
      return None
