...
def select_triviafy_user_login_information_table_slack_all_company_user_uuids_for_quiz_email_function(postgres_connection, postgres_cursor, slack_workspace_team_id, slack_channel_id):
  print('=========================================== select_triviafy_user_login_information_table_slack_all_company_user_uuids_for_quiz_email_function START ===========================================')
  ...
  try:
    ...
    if result_arr == None or result_arr == []:
      print('=========================================== select_triviafy_user_login_information_table_slack_all_company_user_uuids_for_quiz_email_function END ===========================================')
      return None
