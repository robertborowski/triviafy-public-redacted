...
# -------------------------------------------------------------- App Setup
index_page_wip_render_template = Blueprint("index_page_wip_render_template", __name__, static_folder="static", template_folder="templates")
@index_page_wip_render_template.before_request
def before_request():
...
# -------------------------------------------------------------- App
@index_page_wip_render_template.route("/landing_page_wip", methods=['GET','POST'])
def index_page_wip_render_template_function():
  localhost_print_function('=========================================== Landing Page WIP START ===========================================')
  ...
  if server_env == 'true':
    ...
    if get_cookie_value_from_browser == '' or get_cookie_value_from_browser == None:
      browser_response = make_response(render_template('index_page_templates/index_WIP.html', css_cache_busting = cache_busting_output, slack_state_uuid_html = localhost_slack_state_uuid_value))
      ...
      localhost_print_function('=========================================== Landing Page WIP END ===========================================')
      return render_template('index_page_templates/index_WIP.html', css_cache_busting = cache_busting_output, slack_state_uuid_html = localhost_slack_state_uuid_value)
  ...
  # -------------------------------------------------------------- NOT running on localhost
    ...
    if get_cookie_value_from_browser == '' or get_cookie_value_from_browser == None:
      browser_response = make_response(render_template('index_page_templates/index_WIP.html', css_cache_busting = cache_busting_output, slack_state_uuid_html = session['slack_state_uuid_value']))
      browser_response.set_cookie(set_browser_cookie_key, set_browser_cookie_value, expires=datetime.datetime.now() + datetime.timedelta(days=60))
      localhost_print_function('=========================================== Landing Page WIP END ===========================================')
      return browser_response
    else:
