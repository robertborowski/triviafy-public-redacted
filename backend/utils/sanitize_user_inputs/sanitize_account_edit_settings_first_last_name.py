...
def sanitize_account_edit_settings_first_last_name_function(user_input):
  localhost_print_function('=========================================== sanitize_account_edit_settings_first_last_name_function START ===========================================')
  ...
  if len(user_input) < 1 or len(user_input) > 50:
    ...
    localhost_print_function('=========================================== sanitize_account_edit_settings_first_last_name_function END ===========================================')
    return None
