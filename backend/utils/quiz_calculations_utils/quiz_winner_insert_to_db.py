...
from backend.db.queries.select_queries.select_queries_triviafy_quiz_winners_table.select_if_quiz_winner_already_exists import select_if_quiz_winner_already_exists_function
from backend.db.queries.insert_queries.insert_queries_triviafy_quiz_winners_table.insert_triviafy_quiz_winners_table import insert_triviafy_quiz_winners_table_function
