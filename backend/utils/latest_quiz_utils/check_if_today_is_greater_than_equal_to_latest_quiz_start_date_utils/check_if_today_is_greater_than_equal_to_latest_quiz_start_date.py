...
def check_if_today_is_greater_than_equal_to_latest_quiz_start_date_function(quiz_start_day_of_week, quiz_start_time):
  print('=========================================== check_if_today_is_greater_than_equal_to_latest_quiz_start_date_function START ===========================================')
  ...
  if today_date == quiz_official_start_date:
    if current_hour_int >= quiz_start_time_comparison_int:
      ...
      print('today is equal to quiz open date but current time is less than quiz start time')
      print('=========================================== check_if_today_is_greater_than_equal_to_latest_quiz_start_date_function END ===========================================')
      return False
  
  else:
    print('today is not equal to quiz open date')
    print('=========================================== check_if_today_is_greater_than_equal_to_latest_quiz_start_date_function END ===========================================')
    return False
